...
from backend.log_encryption import encrypt_text
...
class EncryptedAuditLogFormatter(logging.Formatter):
    def format(self, record: logging.LogRecord) -> str:
        return encrypt_text(super().format(record)) or ""
...
def configure_audit_logger() -> logging.Logger:
    ...
    file_handler.setFormatter(EncryptedAuditLogFormatter("%(message)s"))
